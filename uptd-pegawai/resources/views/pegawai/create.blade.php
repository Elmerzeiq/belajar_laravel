            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="nama" id="nama"
                        class="form-control @error('nama') is-invalid @enderror" value="{{ old('nama') }}" autofocus>
                    @error('nama')
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="nip" id="nip"
                        class="form-control @error('nip') is-invalid @enderror" value="{{ old('nip') }}" maxlength="20"
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="jabatan" id="jabatan" class="form-select @error('jabatan') is-invalid @enderror">
                        ...
                        <option value="Kepala UPTD" {{ old('jabatan') == 'Kepala UPTD' ? 'selected' : '' }}>Kepala UPTD
                        </option>
                        <option value="Kasi Pengendalian Mutu"
                            {{ old('jabatan') == 'Kasi Pengendalian Mutu' ? 'selected' : '' }}>Kasi Pengendalian Mutu
                        </option>
                        <option value="Teknis" {{ old('jabatan') == 'Teknis' ? 'selected' : '' }}>Teknis</option>
                        <option value="Tata Usaha" {{ old('jabatan') == 'Tata Usaha' ? 'selected' : '' }}>Tata Usaha
                        </option>
                        <option value="Teknologi Informasi"
                            {{ old('jabatan') == 'Teknologi Informasi' ? 'selected' : '' }}>Teknologi Informasi</option>
                    </select>
                    @error('jabatan')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
