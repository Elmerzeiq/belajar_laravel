...
@section('content')
    <div class="container">
        ...
        <form action="{{ route('pegawai.update', $pegawai->id) }}" method="POST"
            onsubmit="return confirm('Yakin ingin mengubah pegawai ini?')" id="pegawai-form" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="nama" id="nama"
                        class="form-control @error('nama') is-invalid @enderror" value="{{ old('nama', $pegawai->nama) }}"
                        autofocus>
                    @error('nama')
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="nip" id="nip"
                        ...
                        maxlength="20" placeholder="Contoh: 123456789012345678 atau 001-BLUD-Labling">
                    @error('nip')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="jabatan" id="jabatan" class="form-select @error('jabatan') is-invalid @enderror">
                        ...
                        <option value="Kepala UPTD"
                            {{ old('jabatan', $pegawai->jabatan) == 'Kepala UPTD' ? 'selected' : '' }}>Kepala UPTD</option>
                        <option value="Kasi Pengendalian Mutu"
                            {{ old('jabatan', $pegawai->jabatan) == 'Kasi Pengendalian Mutu' ? 'selected' : '' }}>Kasi
                            Pengendalian Mutu</option>
                        <option value="Teknis" {{ old('jabatan', $pegawai->jabatan) == 'Teknis' ? 'selected' : '' }}>Teknis
                        </option>
                        <option value="Tata Usaha"
                            {{ old('jabatan', $pegawai->jabatan) == 'Tata Usaha' ? 'selected' : '' }}>Tata Usaha</option>
                        <option value="Teknologi Informasi"
                            {{ old('jabatan', $pegawai->jabatan) == 'Teknologi Informasi' ? 'selected' : '' }}>Teknologi
                            Informasi</option>
                    </select>
                    @error('jabatan')
                        <div class="invalid-feedback">{{ $message }}</div>
                ...
                <!-- Insentif Kotor -->
                <div class="col-md-6 mb-3">
                    <label for="insentif_kotor" class="form-label @error('insentif_kotor') text-danger @enderror">Insentif
                        Kotor</label>
                ...
                <!-- Status Pegawai -->
                <div class="col-md-6 mb-3">
                    <label for="status" class="form-label @error('status') text-danger @enderror">Status Pegawai</label>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    @if ($pegawai->foto)
                        <div class="mt-2">
                            <img src="{{ asset('foto_pegawai/' . $pegawai->foto) }}" alt="Foto Pegawai"
